# Historical checkpoint: iPhone status-bar release

These instructions describe the previous release only. For the current Gate 4 deployment, use START-HERE.md in the project root.
